...
s_a[27]="Banja Luka|Bihać|Doboj|Jablanica|Kakanj|Konjic|Mostar|Neum|Pale|Pocitelj|Stolac|Sarajevo|Tuzla|Travnik|Tarcin|Tesanj|Zenica";
...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.options[0] = new Option('Izaberi grad:','');
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Izaberi drzavu:','-1');
